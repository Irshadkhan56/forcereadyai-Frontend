  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-[#07090e] flex flex-col items-center justify-center space-y-6">
        ...
        <h2 className="text-xl font-bold text-white tracking-wide">Initializing Voice Simulation Room...</h2>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#07090e] flex flex-col items-center justify-center p-6 space-y-6 text-center">
        ...
        <div className="space-y-2 max-w-md">
          <h2 className="text-2xl font-bold text-white">Failed to Load Interview Room</h2>
          <p className="text-gray-300 text-sm">
            {error?.response?.data?.message || 'The interview session details could not be retrieved.'}
          </p>
        </div>
        <Link to="/dashboard" className="px-5 py-2.5 bg-gray-900 border border-gray-800 text-white rounded-xl text-sm font-bold hover:bg-gray-850">
      ...
      <div className="min-h-screen bg-[#07090e] flex items-center justify-center p-6">
        <div className="glass-panel p-8 rounded-2xl text-center space-y-6 max-w-md w-full border border-gray-850">
          ...
          <div className="space-y-2">
            <h2 className="text-2xl font-extrabold text-white">Voice Simulation Complete</h2>
          ...
          <div className="flex gap-4 pt-2">
            <button
              ...
              className="flex-1 border border-gray-800 hover:border-gray-750 bg-gray-900/40 text-white font-bold py-3 px-4 rounded-xl text-sm transition-all cursor-pointer"
            >
              Exit Interview
            </button>
            <Link
    ...
    <div className="min-h-screen bg-[#07090e] text-gray-100 flex flex-col relative overflow-hidden">
      ...
      <header className="border-b border-gray-900/60 bg-[#07090e]/80 backdrop-blur-md px-6 py-4 flex items-center justify-between z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-base font-bold text-white">ForceReady Mock Board</h1>
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-2 text-sm font-mono text-gray-400 bg-gray-950/60 border border-gray-850 px-3 py-1.5 rounded-lg">
            <FaRegClock className="w-4 h-4 text-primary-400" />
        ...
        <div className="lg:col-span-8 space-y-6">
          <div className="glass-panel p-6 md:p-8 rounded-2xl border border-gray-850 space-y-6">
            ...
            <div className="space-y-3">
              <span className="text-xs text-gray-400 font-bold uppercase tracking-wider block">Question Prompt</span>
            ...
            <div className="border-t border-b border-gray-900/60 py-3.5 flex items-center justify-between">
              <span className="text-xs text-gray-300 font-semibold tracking-wide">Audio Prompter:</span>
            ...
            {sessionState === 'active' ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="flex justify-end pt-2">
                  <button
                    ...
                    className="px-6 py-3.5 bg-primary-600 hover:bg-primary-500 text-white font-bold rounded-xl text-sm transition-all shadow-lg flex items-center gap-2 cursor-pointer disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    {submitAnswerMutation.isPending ? (
                      <>
                        <FaSpinner className="w-4 h-4 animate-spin" /> Evaluating Answer...
                      </>
                    ) : (
                      <>
                        Submit Response <FaChevronRight className="w-4 h-4" />
                      </>
                    )}
                  </button>
                </div>
              ...
              <div className="space-y-4 bg-gray-950/50 p-5 border border-gray-900 rounded-xl">
                <span className="text-sm text-gray-400 font-semibold uppercase tracking-wider block">Submitted Transcript</span>
          ...
          {sessionState === 'evaluation' && feedback ? (
            <div className="glass-panel p-6 rounded-2xl border border-gray-800 space-y-6 animate-fadeIn relative">
              <div className="flex items-center justify-between border-b border-gray-900/60 pb-4">
                <div>
                  <h3 className="font-extrabold text-white text-sm uppercase tracking-wider">Board Assessment</h3>
                  <p className="text-xs text-gray-500 font-semibold">Instant AI response evaluation</p>
                </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-gray-300 leading-relaxed bg-emerald-500/[0.02] border border-emerald-500/5 p-3 rounded-lg">
                  {feedback.strengths}
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-gray-300 leading-relaxed bg-red-500/[0.02] border border-red-500/5 p-3 rounded-lg">
                  {feedback.weaknesses}
                </p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-sm text-gray-300 leading-relaxed bg-amber-500/[0.02] border border-amber-500/5 p-3 rounded-lg">
              ...
              <button
                ...
                className="w-full bg-primary-600 hover:bg-primary-500 text-white font-bold py-3.5 px-4 rounded-xl text-sm transition-all shadow-md flex items-center justify-center gap-1.5 cursor-pointer mt-4"
              >
                {currentQuestionIdx === totalQuestions - 1 ? (
                  <>
                    Complete Interview <FaCheckCircle className="w-4 h-4" />
                  </>
                ) : (
                  <>
                    Next Board Question <FaChevronRight className="w-4 h-4" />
                  </>
                )}
              </button>
            </div>
          ) : (
            <div className="glass-panel p-6 rounded-2xl border border-gray-855 text-center py-10 space-y-4">
              <FaQuestionCircle className="w-10 h-10 text-gray-700 mx-auto" />
              <div className="space-y-1">
                <h4 className="font-bold text-white text-sm uppercase tracking-wide">Pending Response</h4>
                <p className="text-gray-400 text-xs max-w-[200px] mx-auto leading-normal">
